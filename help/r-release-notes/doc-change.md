...
||[Adobe Target cookies](experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-target.html)<br>(*Experience Cloud Services and Administration* guide)|Added additional information about "session ID."|
