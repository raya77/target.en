...
description: Learn how to send additional information about the location or the user to Adobe [!DNL Target] as name-value pairs to help you build custom audiences.
