...
Your next step should be to set up users in Target Standard and Target Premium. For more information, see [User management](/help/main/administrating-target/c-user-management/user-management.md).
