...
* **Input data**: Behavioral data, in the form of views and purchases of visitors collected when you [implement Target](/help/main/c-recommendations/plan-implement.md#pass-behavioral) or from [Adobe Analytics](/help/main/c-recommendations/c-algorithms/use-adobe-analytics-with-recommendations.md).
...
* **Input data**: As described before, this algorithm is based purely on catalog data (ingested to [!DNL Target] via a [Catalog Feed, the Entities API, or from on-page updates](/help/main/c-recommendations/plan-implement.md#rec-catalog).
