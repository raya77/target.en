...
Using audiences in [!DNL Adobe Target] created in [!DNL Adobe Experience Platform] provide richer customer data that leads to more impactful personalization.
...
For more information, see [Use audiences from Adobe Experience Platform](/help/main/c-target/c-audiences/audiences.md#aep) in *Create audiences*.
