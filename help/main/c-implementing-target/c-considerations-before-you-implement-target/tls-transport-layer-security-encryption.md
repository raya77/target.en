...
For more details about supported browsers and their versions, see [Supported Browsers](/help/main/c-implementing-target/c-considerations-before-you-implement-target/supported-browsers.md#reference_01B4BF99E7D545A7998773202A2F6100).
...
Because the Target Standard/Premium interface already requires a [modern web browser](/help/main/c-implementing-target/c-considerations-before-you-implement-target/supported-browsers.md#reference_01B4BF99E7D545A7998773202A2F6100), we do not anticipate issues. If you are unable to connect to Target, you should upgrade your browser to the latest version.
...
1. Open the Security tab, then examine the TLS version information under Connection:
   ...
   ![TLS version details](/help/main/c-implementing-target/c-considerations-before-you-implement-target/assets/chrome-tls-version.png)
