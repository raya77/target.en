...
1. Implement the [!DNL at.js] library on your site.
   ...
   See [How to deploy at.js](https://developer.adobe.com/target/implement/client-side/atjs/how-to-deployatjs/how-to-deployatjs/){target=_blank} for more information.
