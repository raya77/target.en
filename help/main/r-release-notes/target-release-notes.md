...
* Added the ability to filter [!DNL Adobe Experience Manager] (AEM) [experience fragments](/help/main/c-experiences/c-manage-content/aem-experience-fragments.md) by type (HTML or JSON) in the [!UICONTROL Offers] list. (TGT-43121)
