...
* Fixed an issue to ensure that customers can properly edit and delete objects (designs, criteria, collections, and so forth) using the [!DNL Target] UI in [!UICONTROL A/B Test] and [!UICONTROL Experience Targeting] (XT) activities that contain recommendations. (TGT-42331)
