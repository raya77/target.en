...
|Date|Topic|Changes|
| --- | --- | --- |
|June 24|[Adobe Target Developer Guide portal](https://developer-stage.adobe.com/target/){target=_blank}|Launched the *Adobe Target Developer Guide* portal to consolidate all [!DNL Target] developer content in one convenient portal. The portal includes information about implementing [!DNL Target] and [!DNL Recommendations], [!DNL Target] SDKs, and [!DNL Target] APIs.|
