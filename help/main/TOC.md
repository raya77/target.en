...
+ Implement Target {#implement-target}
   ...
   + Before you implement {#before-implement}
      ...
      + Methods to get data into Target {#methods}
         ...
         + [Page parameters](/help/main/c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/page-parameters.md)
         + [In-page profile attributes](/help/main/c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/in-page-profile-attributes.md)
         + [Script profile attributes](/help/main/c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/script-profile-attributes.md)
         + [Data providers](/help/main/c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/data-providers.md)
         + [Bulk profile update API](/help/main/c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/bulk-profile-update-api.md)
         ...
         + [Customer attributes](/help/main/c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/customer-attributes.md)
   ...
   + Client-side web: implement Target {#client-side}
      ...
      + Adobe Experience Platform Web SDK implementation {#aep-implementation}
         + [AEP Web SDK overview](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/aep-web-sdk.md)
      + at.js implementation {#at-js-implementation}
         + On-device decisioning {#on-device-decisioning}
            + [On-device decisioning overview](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/on-device-decisioning.md)
            + [Supported features](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/supported-features.md)
            + [Rule artifact](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/rule-artifact.md)
            + [Troubleshooting](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/troubleshooting-on-device-decisioning.md)
         ...
         + How to deploy at.js {#deploy-at-js}
            ...
            + [Implement Target using Adobe Experience Platform](c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/cmp-implementing-target-using-adobe-launch.md)
         ...
         + [User-agent and Client Hints](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/user-agent-and-client-hints.md)
   ...
   + Target for mobile apps {#mobile-apps}
      ...
      + [Use Location Service](/help/main/c-target-mobile-app/use-location-service.md)
   + Server Side: implement Target {#server-side}
      ...
      + [On-device decisioning](/help/main/c-implementing-target/c-api-and-sdk-overview/on-device-decisioning.md)
   + [Hybrid implementation](/help/main/c-implementing-target/hybrid-implementation.md)
