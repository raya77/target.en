...
description: Learn how to use the Visual Experience Composer (VEC) in Adobe [!DNL Target] to create the offers you want to include in your Multivariate Test (MVT).
