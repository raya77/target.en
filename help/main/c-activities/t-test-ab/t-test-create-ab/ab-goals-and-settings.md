...
description: Learn how to use the Goals and Settings page in Adobe [!DNL Target] to specify information about the goals of an A/B activity.
...
The available settings depend on whether you use Target or [Analytics](/help/main/c-integrating-target-with-mac/a4t/a4t.md) as the data source.

![Activity Settings dialog box](/help/main/c-activities/t-test-ab/t-test-create-ab/assets/ab_settings-new.png)
