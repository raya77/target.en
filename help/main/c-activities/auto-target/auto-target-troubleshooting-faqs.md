...
---
# ![PREMIUM](/help/main/assets/premium.png) Auto-Target troubleshooting and FAQs
...
### Do you recommend that we use [!UICONTROL Auto Target] with a 90(Control)/10(Targeted) split until the models are built?
