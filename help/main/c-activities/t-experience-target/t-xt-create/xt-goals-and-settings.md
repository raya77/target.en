...
description: Learn how to use the Goals and Settings page in Adobe [!DNL Target] to specify information about the goals of an Experience Targeting (XT) activity.
...
![Activity Settings page](/help/main/c-activities/t-experience-target/t-xt-create/assets/ab_settings-new.png)
...
Specify whether data is collected from Adobe Target or from Adobe Analytics. See [Adobe Analytics as the Reporting Source for Target](/help/main/c-integrating-target-with-mac/a4t/a4t.md) to learn about the differences between the reporting solutions and the advantages of each.
