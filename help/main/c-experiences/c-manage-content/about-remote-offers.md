...
description: Learn how to use remote offers in Adobe [!DNL Target] to host outside content (content in a CMS or other system). Discover why you might want to use remote offers.
...
>[!NOTE]
>
>Remote offers can be created on the [!UICONTROL Offers] > [!UICONTROL Code Offers] page or in the [Forms-Based Experience Composer](/help/main/c-experiences/form-experience-composer.md). You cannot create or apply remote offers in the Visual Experience Composer (VEC). Content will be injected in the [!DNL Target] request locations, so these are most likely not appropriate for a global [!DNL Target] request.
>
...
1. Click **[!UICONTROL Offers]**, then select the **[!UICONTROL Code Offers]** tab.
   ...
   ![Offers > Code Offers](/help/main/c-experiences/c-manage-content/assets/offers-code-offers.png)
