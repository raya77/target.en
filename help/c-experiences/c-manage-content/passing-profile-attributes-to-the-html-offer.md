...
description: Learn how to pass dynamic data into Adobe [!DNL Target] Offers. Explore business cases that show why you might want to use dynamic offers and view examples and implementation information.
